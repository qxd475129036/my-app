...
export default function LoginPage() {
  ...
  return (
    <div className="flex min-h-screen">
      {/* Left: Brand panel — follows env gradient */}
      <div
        style={{ background: "var(--env-gradient)" }}
        className="hidden lg:flex lg:w-1/2 flex-col items-center justify-center text-white relative overflow-hidden"
      >
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12 lg:px-12">
        <div className="w-full max-w-sm">
          <div className="lg:hidden mb-10 text-center">
            <div
              style={{ background: "var(--env-gradient)" }}
              className="inline-flex items-center justify-center h-12 w-12 rounded-xl text-white mb-4"
            >
